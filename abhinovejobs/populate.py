import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'abhinovejobs.settings')
import django
django.setup()
...
def populate(n):
    for i in range(n):
        ...
        beng_jobs_records = BengJobs.objects.get_or_create(
            date = fdate,
            company = fcompany,
            title = ftitle,
            eligibility = feligibility,
        ...
        chennai_jobs_records = chennaiJobs.objects.get_or_create(
            date = fdate,
            company = fcompany,
            title = ftitle,
            eligibility = feligibility,
